...
class Post(models.Model):
    ...
    class Meta:
        ordering = ['-pub_date']  # Добавлено для пагинации
...
class Follow(models.Model):
    ...
    class Meta:
        constraints = [
            ...
            models.CheckConstraint(check=~models.Q(user=models.F('following')), name='prevent_self_follow')  # Против самоподписки
        ]

# posts/admin.py (новый файл)
